#!/usr/bin/env bash
# =============================================================================
# Identity Research for Agent Management Using SPIFFE — GCP Project Bootstrap
# =============================================================================
...
if gcloud projects describe "$GCP_PROJECT_ID" &>/dev/null; then
    ...
    CREATE_ARGS=(--name "Identity Research for Agent Management Using SPIFFE Cross-Cloud PoC")
...
if gcloud iam service-accounts describe "$GCP_SA_EMAIL" &>/dev/null 2>&1; then
    ...
    gcloud iam service-accounts create "$GCP_SA_NAME" \
        --display-name="Identity Research for Agent Management Using SPIFFE Cross-Cloud Agent" \
        --description="Service account for the Google-hosted Identity Research for Agent Management Using SPIFFE budget reader agent"
