...
LEGACY_BLUEPRINT_DISPLAY_NAME = "AIM Prototype Platform Budget Backend Agents"
LEGACY_PORTAL_MANAGEMENT_APP_DISPLAY_NAME = "AIM Portal - Management"
LEGACY_PORTAL_CROWDSTRIKE_APP_DISPLAY_NAME = "AIM Portal - CrowdStrike Mock"
LEGACY_PORTAL_ADMIN_GROUP_DISPLAY_NAME = "AIM Administrators"
LEGACY_PORTAL_VIEWER_GROUP_DISPLAY_NAME = "AIM Viewers"
...
def portal_crowdstrike_app_display_name(scope: EntraScope) -> str:
    if scope.mode == SCOPE_MODE_LEGACY:
        return LEGACY_PORTAL_CROWDSTRIKE_APP_DISPLAY_NAME
    return f"{LEGACY_PORTAL_CROWDSTRIKE_APP_DISPLAY_NAME} [{scope.env_name}]"
...
def summary_values(scope: EntraScope) -> dict[str, str]:
    values = {
        ...
        "ENTRA_SCOPE_PORTAL_CROWDSTRIKE_APP_DISPLAY_NAME": portal_crowdstrike_app_display_name(scope),
...
def _emit_name(scope: EntraScope, kind: str, agent_name: str | None) -> int:
    ...
    if kind == "portal-management-app":
        ...
        return 0
    if kind == "portal-crowdstrike-app":
        print(portal_crowdstrike_app_display_name(scope))
        return 0
