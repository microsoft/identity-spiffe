#!/bin/bash
# =============================================================================
# AIM Prototype Platform — Provision a GitHub Actions Cross-Cloud Agent
# =============================================================================
...
# AIM's RBAC engine, not by per-repo FICs. This solves the 20-FIC-per-app
# scaling limit.
#
# Prerequisites:
...
echo ""
echo "============================================================"
echo "  AIM — Provision GitHub Actions Agent: ${AGENT_NAME}"
echo "============================================================"
echo ""
