...
ATTRIBUTE_SET_DESCRIPTION = "Custom security attributes for AIM agent identity governance"
...
CA_POLICY_NAME = "AIM: Block agents based on risk"
OLD_CA_POLICY_NAME = "AIM: Block non-Finance agents from Budget Backend"
...
def main():
    print("=" * 66)
    print("  AIM Prototype Platform — Custom Security Attribute Provisioning")
