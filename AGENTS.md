# AGENTS.md — Identity Research for Agent Management Using SPIFFE

> Canonical contributor and AI-agent guidance. Durable architecture and runbooks live in `docs/`.
...
When Copilot authors a commit, include:
