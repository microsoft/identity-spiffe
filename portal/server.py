#!/usr/bin/env python3
"""Thin compatibility wrapper for the Identity Research for Agent Management Using SPIFFE portal application."""
...
def main():
    # type: () -> None
    parser = argparse.ArgumentParser(description="Run the Identity Research for Agent Management Using SPIFFE portal server")
