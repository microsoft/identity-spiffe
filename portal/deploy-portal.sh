...
###############################################################################
# Identity Research for Agent Management Using SPIFFE — Control Panel Launcher
#
# This script:
...
header "Identity Research for Agent Management Using SPIFFE — Control Panel"
...
install_and_launch() {
  ...
  echo -e "${GREEN}${BOLD}  │                                                 │${NC}"
  echo -e "${GREEN}${BOLD}  │   🛡️  Identity Research for Agent Management Using SPIFFE Control Panel                 │${NC}"
  echo -e "${GREEN}${BOLD}  │                                                 │${NC}"
