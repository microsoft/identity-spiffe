"""
Shared JWT Validator for Identity Research for Agent Management Using SPIFFE Portals
========================================
Validates Entra ID JWT tokens for the Identity Research for Agent Management Using SPIFFE portal and security portal mock.
