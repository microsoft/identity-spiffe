# AGENTS.md — Infrastructure (Bicep)

> All Azure infrastructure-as-code for the Identity Research for Agent Management Using SPIFFE. Deployed via `azd provision` (Step 1 of deploy.sh).
