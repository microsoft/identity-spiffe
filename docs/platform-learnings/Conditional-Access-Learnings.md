...
> **Purpose:** Comprehensive reference for Claude Code instances working on CA enforcement in the AIM PoC. Load this file before working on admin governance, Layer 4 enforcement, agent risk, or custom security attributes.
>
...
10. [How This Maps to AIM PoC](#how-this-maps-to-aim-poc)
...
For the PoC, we simulate agent risk via an external "CrowdStrike" mock portal:
...
| Risk signal source | Mock CrowdStrike portal → mgmt API | Microsoft Defender / ID Protection → Entra |
