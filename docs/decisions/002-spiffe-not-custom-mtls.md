...
- **Maps to Project AIM's Agent Identity model.** Agent Blueprint → SPIFFE trust domain, Agent Identity → SPIFFE workload registration, Agent User → delegated identity chain.
